...
dataSource:any;
displayedColumns=['KategoriId','KategoriAd','detay']
dialogRef:MatDialogRef<KategorimDialogComponent>
...
@ViewChild(MatPaginator) paginator : MatPaginator;
  ...
  Ekle(){
    ...
    this.dialogRef=this.matDialog.open(KategorimDialogComponent,{
      width:'400px',
      data:{
        kayit:yeniKayit,
        islem:'ekle'
